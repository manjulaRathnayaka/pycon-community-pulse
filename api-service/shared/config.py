...
class Config:
    ...
    _db_host = os.getenv("CHOREO_PYCON_API_DEFAULTDB_HOSTNAME")
    _db_port = os.getenv("CHOREO_PYCON_API_DEFAULTDB_PORT")
    _db_user = os.getenv("CHOREO_PYCON_API_DEFAULTDB_USERNAME")
    _db_password = os.getenv("CHOREO_PYCON_API_DEFAULTDB_PASSWORD")
    _db_name = os.getenv("CHOREO_PYCON_API_DEFAULTDB_DATABASENAME")
